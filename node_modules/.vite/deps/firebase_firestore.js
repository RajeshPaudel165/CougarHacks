...
async function __PRIVATE_ignoreIfPrimaryLeaseLoss(e) {
  if (e.code !== F.FAILED_PRECONDITION || e.message !== L) throw e;
  ...
  async k(e) {
    return this.db || (__PRIVATE_logDebug(k, "Opening database:", this.name), this.db = await new Promise((t, n) => {
      ...
      r.onsuccess = (e2) => {
        ...
        "VersionError" === r2.name ? n(new FirestoreError(F.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : "InvalidStateError" === r2.name ? n(new FirestoreError(F.FAILED_PRECONDITION, "Unable to open an IndexedDB connection. This could be due to running in a private browsing session on a browser whose private browsing sessions do not support IndexedDB: " + r2)) : n(new __PRIVATE_IndexedDbTransactionError(e, r2));
...
function __PRIVATE_checkForAndReportiOSError(e) {
  ...
  if (t >= 12.2 && t < 13) {
    ...
    if (e.message.indexOf(t2) >= 0) {
      ...
      return q || (q = true, // Throw a global exception outside of this promise chain, for the user to
      // potentially catch.
      setTimeout(() => {
        throw e2;
      }, 0)), e2;
...
var __PRIVATE_IndexBackfiller = class {
  ...
  _e(e, t, n) {
    return this.localStore.indexManager.getMinOffsetFromCollectionGroup(e, t).next((r) => this.localStore.localDocuments.getNextDocuments(e, t, r, n).next((n2) => {
      const i = n2.changes;
      return this.localStore.indexManager.updateIndexEntries(e, i).next(() => this.ae(r, n2)).next((n3) => (__PRIVATE_logDebug(Q, `Updating offset: ${n3}`), this.localStore.indexManager.updateCollectionGroup(e, t, n3))).next(() => i.size);
    }));
  }
...
var qe = "collectionPathOverlayIndex";
var Qe = ["userId", "collectionPath", "largestBatchId"];
var $e = "collectionGroupOverlayIndex";
...
var BloomFilter = class _BloomFilter {
  ...
  we(e, t, n) {
    ...
    return 1 === r.compare(Vt) && (r = new Integer([r.getBits(0), r.getBits(1)], 0)), r.modulo(this.ye).toNumber();
  }
    ...
    if (r) {
      ...
      if (__PRIVATE_targetIsDocumentTarget(i)) if (0 === n) {
        ...
        if (r2 !== n) {
          ...
          null == Rt || Rt.ht(function __PRIVATE_createExistenceFilterMismatchInfoForTestingHooks(e2, t2, n3, r3, i3) {
            var s, o, _, a, u, c;
            const l = {
              localCacheCount: e2,
...
function __PRIVATE_fromWatchChange(e, t) {
  ...
  if ("targetChange" in t) {
    ...
    const r = function __PRIVATE_fromWatchTargetChangeState(e2) {
      ...
      const t2 = void 0 === e2.code ? F.UNKNOWN : __PRIVATE_mapCodeFromRpcCode(e2.code);
...
var __PRIVATE_IndexedDbDocumentOverlayCache = class ___PRIVATE_IndexedDbDocumentOverlayCache {
  ...
  removeOverlaysForBatchId(e, t, n) {
    ...
    return r.forEach((t2) => {
      ...
      i.push(__PRIVATE_documentOverlayStore(e).X(qe, r2));
  ...
  getOverlaysForCollection(e, t, n) {
    ...
    return __PRIVATE_documentOverlayStore(e).J(qe, s).next((e2) => {
      for (const t2 of e2) {
...
var __PRIVATE_OrderedCodeWriter = class {
  ...
  zt(e) {
    const t = 255 & e;
    0 === t ? (this._n(0), this._n(255)) : t === pt ? (this._n(pt), this._n(0)) : this._n(t);
  }
  /** Writes a single byte descending to the buffer.  */
  Jt(e) {
    const t = 255 & e;
    0 === t ? (this.un(0), this.un(255)) : t === pt ? (this.un(pt), this.un(0)) : this.un(e);
  }
  jt() {
    this._n(0), this._n(1);
  }
...
var __PRIVATE_TargetIndexMatcher = class {
  ...
  Vn(e) {
    ...
    if (void 0 !== t && !this.mn(t)) return false;
    const n = __PRIVATE_fieldIndexGetDirectionalSegments(e);
    let r = /* @__PURE__ */ new Set(), i = 0, s = 0;
    for (; i < n.length && this.mn(n[i]); ++i) r = r.add(n[i].fieldPath.canonicalString());
    if (i === n.length) return true;
    if (this.En.size > 0) {
      const e2 = this.En.getIterator().getNext();
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.fn(e2, t2) || !this.gn(this.dn[s++], t2)) return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
      const e2 = n[i];
      if (s >= this.dn.length || !this.gn(this.dn[s++], e2)) return false;
    }
    return true;
  }
  /**
  ...
  mn(e) {
    for (const t of this.An) if (this.fn(t, e)) return true;
    return false;
  }
  fn(e, t) {
...
var __PRIVATE_IndexedDbIndexManager = class {
  ...
  Fn(e, t, n, r, i, s, o) {
    ...
    for (let c = 0; c < _; ++c) {
      const _2 = t ? this.Mn(t[c / a]) : wt, l = this.xn(e, _2, n[c % a], r), h = this.On(e, _2, i[c % a], s), P = o.map((t2) => this.xn(
        e,
        _2,
        t2,
        /* inclusive= */
  ...
  Cn(e, t, n) {
    ...
    for (const s of __PRIVATE_fieldIndexGetDirectionalSegments(e)) {
      const e2 = n[i++];
      for (const n2 of r) if (this.Ln(t, s.fieldPath) && isArray(e2)) r = this.kn(r, s, e2);
      else {
  ...
  getFieldIndexes(e, t) {
    ...
    return (t ? n.J(Se, IDBKeyRange.bound(t, t)) : n.J()).next((e2) => {
      const t2 = [];
  ...
  updateCollectionGroup(e, t, n) {
    ...
    return this.Qn(e).next((e2) => r.J(Se, IDBKeyRange.bound(t, t)).next((t2) => PersistencePromise.forEach(t2, (t3) => i.put(__PRIVATE_toDbIndexState(t3.indexId, this.uid, e2, n)))));
  }
  updateIndexEntries(e, t) {
  ...
  Un(e, t) {
    ...
    if (null != i) {
      ...
      if (isArray(s)) for (const i2 of s.arrayValue.values || []) n = n.add(new __PRIVATE_IndexEntry(t.indexId, e.key, this.Mn(i2), r));
  ...
  createRange(e, t, n) {
    ...
    for (let e2 = 0; e2 < r.length; e2 += 2) {
      ...
      const t2 = [r[e2].indexId, this.uid, r[e2].arrayValue, r[e2].directionalValue, wt, []], n2 = [r[e2 + 1].indexId, this.uid, r[e2 + 1].arrayValue, r[e2 + 1].directionalValue, wt, []];
...
var __PRIVATE_IndexedDbMutationQueue = class ___PRIVATE_IndexedDbMutationQueue {
  ...
  getAllMutationBatches(e) {
    ...
    return __PRIVATE_mutationsStore(e).J(Y, t).next((e2) => e2.map((e3) => __PRIVATE_fromDbMutationBatch(this.serializer, e3)));
  }
...
var __PRIVATE_RollingSequenceNumberBuffer = class {
  ...
  Pr(e) {
    const t = [e, this.hr()];
    if (this.buffer.size < this.cr) this.buffer = this.buffer.add(t);
    else {
...
var __PRIVATE_LruScheduler = class {
  ...
  Ir(e) {
    __PRIVATE_logDebug(Dt, `Garbage collection scheduled in ${e}ms`), this.Tr = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection", e, async () => {
      this.Tr = null;
      try {
...
var __PRIVATE_SchemaConverter = class {
  ...
  q(e, t, n, r) {
    ...
    (0 !== n && (!function __PRIVATE_dropQueryCache(e2) {
      e2.deleteObjectStore(he), e2.deleteObjectStore(ue), e2.deleteObjectStore(de);
    ...
    (s = s.next(() => function __PRIVATE_upgradeMutationBatchSchemaAndMigrateData(e2, t2) {
    ...
    }(e)).next(() => this.yi(e, i)).next(() => e.deleteObjectStore(K))), n < 14 && r >= 14 && (s = s.next(() => this.wi(e, i))), n < 15 && r >= 15 && (s = s.next(() => function __PRIVATE_createFieldIndex(e2) {
      ...
      const n2 = e2.createObjectStore(ve, {
        keyPath: Ce
      });
  ...
  Vi(e) {
    ...
    return t.J().next((t2) => PersistencePromise.forEach(t2, (t3) => {
      ...
      return n.J(Y, r).next((n2) => PersistencePromise.forEach(n2, (n3) => {
   ...
   */
    ...
    const t = e.store(he), n = e.store(K);
    return e.store(de).get(Ee).next((e2) => {
      const r = [];
      return n.te((n2, i) => {
  ...
  wi(e, t) {
    const n = t.store(H), r = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), i = new __PRIVATE_MemoryPersistence(__PRIVATE_MemoryEagerDelegate.Ei, this.serializer.wt);
    return n.J().next((e2) => {
      const n2 = /* @__PURE__ */ new Map();
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r, i, s, o, _, a, u, c = 17) {
    ...
    this.Ni = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.C()) throw new FirestoreError(F.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
    this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, r), this.Bi = t + Ot, this.serializer = new __PRIVATE_LocalSerializer(_), this.Li = new __PRIVATE_SimpleDb(this.Bi, this.Ci, new __PRIVATE_SchemaConverter(this.serializer)), this._i = new __PRIVATE_IndexedDbGlobalsCache(), this.ai = new __PRIVATE_IndexedDbTargetCache(this.referenceDelegate, this.serializer), this.remoteDocumentCache = __PRIVATE_newIndexedDbRemoteDocumentCache(this.serializer), this.ci = new __PRIVATE_IndexedDbBundleCache(), this.window && this.window.localStorage ? this.ki = this.window.localStorage : (this.ki = null, false === u && __PRIVATE_logError(Ct, "LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."));
  }
  /**
  ...
  start() {
    return this.qi().then(() => {
      if (!this.isPrimary && !this.allowTabSynchronization)
        throw new FirestoreError(F.FAILED_PRECONDITION, xt);
  ...
  qi() {
    return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (e) => __PRIVATE_clientMetadataStore(e).put({
      ...
      if (__PRIVATE_isIndexedDbTransactionError(e))
        return __PRIVATE_logDebug(Ct, "Failed to extend owner lease: ", e), this.isPrimary;
      if (!this.allowTabSynchronization) throw e;
      return __PRIVATE_logDebug(Ct, "Releasing owner lease after error during lease refresh", e), /* isPrimary= */
      false;
    }).then((e) => {
  ...
  Wi(e) {
    return __PRIVATE_primaryClientStore(e).get(G).next((e2) => PersistencePromise.resolve(this.Hi(e2)));
  }
  Ji(e) {
   ...
   */
  async Yi() {
    if (this.isPrimary && !this.Zi(this.Oi, Ft)) {
      this.Oi = Date.now();
      const e = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (e2) => {
        ...
        return t.J().next((e3) => {
          const n = this.Xi(e3, Ft), r = e3.filter((e4) => -1 === n.indexOf(e4));
          return PersistencePromise.forEach(r, (e4) => t.delete(e4.clientId)).next(() => r);
        });
      }).catch(() => []);
      if (this.ki) for (const t of e) this.ki.removeItem(this.es(t.clientId));
    }
  }
  /**
   ...
   */
  Gi(e) {
    if (this.Di) return PersistencePromise.resolve(true);
    return __PRIVATE_primaryClientStore(e).get(G).next((t) => {
      if (null !== t && this.Zi(t.leaseTimestampMs, Mt) && !this.ts(t.ownerId)) {
        if (this.Hi(t) && this.networkEnabled) return true;
        if (!this.Hi(t)) {
      ...
      return !(!this.networkEnabled || !this.inForeground) || __PRIVATE_clientMetadataStore(e).J().next((e2) => void 0 === this.Xi(e2, Mt).find((e3) => {
    ...
    }).next((e2) => (this.isPrimary !== e2 && __PRIVATE_logDebug(Ct, `Client ${e2 ? "is" : "is not"} eligible for a primary lease.`), e2));
  }
  async shutdown() {
    ...
    await this.Li.runTransaction("shutdown", "readwrite", [W, Ve], (e) => {
   ...
   */
  us() {
    return this.runTransaction("getActiveClients", "readonly", (e) => __PRIVATE_clientMetadataStore(e).J().next((e2) => this.Xi(e2, Ft).map((e3) => e3.clientId)));
  }
  get started() {
    return this.oi;
  }
  ...
  runTransaction(e, t, n) {
    __PRIVATE_logDebug(Ct, "Starting transaction:", e);
    const r = "readonly" === t ? "readonly" : "readwrite", i = (
      /** Returns the object stores for the provided schema. */
      function __PRIVATE_getObjectStores(e2) {
        return 17 === e2 ? Ze : 16 === e2 ? Ye : 15 === e2 ? Je : 14 === e2 ? He : 13 === e2 ? je : 12 === e2 ? ze : 11 === e2 ? Ge : void fail(60245);
      }(this.Ci)
    );
    let s;
    return this.Li.runTransaction(e, r, i, (r2) => (s = new __PRIVATE_IndexedDbTransaction(r2, this.si ? this.si.next() : __PRIVATE_ListenSequence.le), "readwrite-primary" === t ? this.Wi(s).next((e2) => !!e2 || this.Gi(s)).next((t2) => {
      if (!t2) throw __PRIVATE_logError(`Failed to obtain primary lease for action '${e}'.`), this.isPrimary = false, this.bi.enqueueRetryable(() => this.Ni(false)), new FirestoreError(F.FAILED_PRECONDITION, L);
      return n(s);
  ...
  cs(e) {
    return __PRIVATE_primaryClientStore(e).get(G).next((e2) => {
      if (null !== e2 && this.Zi(e2.leaseTimestampMs, Mt) && !this.ts(e2.ownerId) && !this.Hi(e2) && !(this.Di || this.allowTabSynchronization && e2.allowTabSynchronization)) throw new FirestoreError(F.FAILED_PRECONDITION, xt);
    });
  }
  /**
  ...
  zi(e) {
    ...
    return t.get(G).next((e2) => this.Hi(e2) ? (__PRIVATE_logDebug(Ct, "Releasing primary lease."), t.delete(G)) : PersistencePromise.resolve());
  }
  ...
  ts(e) {
    ...
    try {
      ...
      return __PRIVATE_logDebug(Ct, `Client '${e}' ${n ? "is" : "is not"} zombied in LocalStorage`), n;
    } catch (e2) {
      return __PRIVATE_logError(Ct, "Failed to get zombied client id.", e2), false;
    }
  }
  /**
...
function __PRIVATE_localStoreExecuteQuery(e, t, n) {
  ...
  return r.persistence.runTransaction(
    ...
    (e2) => function __PRIVATE_localStoreGetTargetData(e3, t2, n2) {
      ...
      if (t2) return i = t2.lastLimboFreeSnapshotVersion, r.ai.getMatchingKeysForTargetId(e2, t2.targetId).next((e3) => {
        s = e3;
      });
...
async function __PRIVATE_localStoreSaveNamedQuery(e, t, n = __PRIVATE_documentKeySet()) {
  ...
  return i.persistence.runTransaction("Save named query", "readwrite", (e2) => {
    ...
    if (r.snapshotVersion.compareTo(s) >= 0) return i.ci.saveNamedQuery(e2, t);
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r, i) {
    ...
    }(this.persistenceKey), this.zs = this.zs.insert(this.Ks, new __PRIVATE_LocalClientState()), this.Ys = new RegExp(`^${Lt}_${s}_([^_]*)$`), this.Zs = new RegExp(`^${kt}_${s}_(\\d+)(?:_(.*))?$`), this.Xs = new RegExp(`^${qt}_${s}_(\\d+)$`), this.eo = /** Assembles the key for the online state of the primary tab. */
  ...
  async start() {
    ...
    for (const e2 of this.js) this.Gs(e2);
  ...
  Gs(e) {
    ...
    if (t.storageArea === this.storage) {
      if (__PRIVATE_logDebug(Qt, "EVENT", t.key, t.newValue), t.key === this.Hs) return void __PRIVATE_logError("Received WebStorage notification for local change. Another client might have garbage-collected our state");
          ...
          if (null !== t.key) {
            if (this.Ys.test(t.key)) {
              ...
              }
              {
                ...
                if (e2) return this.To(e2.clientId, e2);
              }
  ...
  async Ao(e) {
    if (e.user.uid === this.currentUser.uid) return this.syncEngine.yo(e.batchId, e.state, e.error);
...
var __PRIVATE_PersistentStream = class {
  ...
  async close(e, t) {
    ...
    ) : t && t.code === F.UNAUTHENTICATED && 3 !== this.state && // "unauthenticated" error means the token was rejected. This should rarely
  ...
  auth() {
    ...
    Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then(([e2, n]) => {
      ...
      e(() => {
        const e2 = new FirestoreError(F.UNKNOWN, "Fetching auth token failed: " + t2.message);
        return this.L_(e2);
      });
    });
  }
  ...
  N_(e) {
    return (t) => {
      this.bi.enqueueAndForget(() => this.m_ === e ? t() : (__PRIVATE_logDebug(zt, "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.ha.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.ha.ot(t) : e.ha.nt(t), !n.isEqual(SnapshotVersion.min())) try {
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug(jt, "Retrying IndexedDB access"), await n(), e.aa.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_fillWritePipeline(e) {
  ...
  let r = t.oa.length > 0 ? t.oa[t.oa.length - 1].batchId : $;
...
async function __PRIVATE_onWriteHandshakeComplete(e) {
  ...
  for (const n of e.oa) t.G_(n.mutations);
}
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  ...
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      return __PRIVATE_isPermanentError(e3) && e3 !== F.ABORTED;
    }(t2.code)) {
      const n = e2.oa.shift();
...
function __PRIVATE_ensureWriteStream(e) {
  ...
  (e.Ta = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    ...
    await __PRIVATE_fillWritePipeline(e)) : (await e.Ta.stop(), e.oa.length > 0 && (__PRIVATE_logDebug(jt, `Stopping write stream with ${e.oa.length} pending writes`), e.oa = []));
  })), e.Ta;
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e2 of t) {
    ...
    if (i) {
      for (const t3 of i.Ra) t3.pa(e2) && (r = true);
      i.Aa = e2;
    }
  }
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
  ...
  if (i) for (const e2 of i.Ra) e2.onError(n);
  r.queries.delete(t);
}
...
var __PRIVATE_BundleLoader = class {
  ...
  Na(e) {
    ...
    if (e.Ma.namedQuery) this.queries.push(e.Ma.namedQuery);
    ...
    } else e.Ma.document && (this.documents[this.documents.length - 1].document = e.Ma.document, ++t);
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1) return r.iu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.ru.delete(t);
...
async function __PRIVATE_syncEngineRegisterPendingWritesCallback(e, t) {
  const n = __PRIVATE_debugCast(e);
  __PRIVATE_canUseNetwork(n.remoteStore) || __PRIVATE_logDebug(Yt, "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
  try {
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.iu.get(t)) e.ru.delete(r), n && e.nu.Tu(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.au.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
    ...
    __PRIVATE_logDebug(Yt, "Document no longer in limbo: " + r.key), e.au.removeReference(r.key, t);
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.ou.get(n) || e.su.has(r) || (__PRIVATE_logDebug(Yt, "New document in limbo: " + n), e.su.add(r), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  ...
  if (r && r.tu) return __PRIVATE_documentKeySet().add(r.key);
  {
    let e2 = __PRIVATE_documentKeySet();
    const r2 = n.iu.get(t);
    if (!r2) return e2;
...
async function __PRIVATE_syncEngineApplyBatchState(e, t, n, r) {
  ...
  null !== s ? ("pending" === n ? (
    ...
    // as applicable.
    __PRIVATE_logDebug(Yt, "Cannot apply mutation batch with id: " + t)
  );
}
...
async function __PRIVATE_syncEngineApplyTargetState(e, t, n, r) {
  const i = __PRIVATE_debugCast(e);
  if (i.hu)
    return void __PRIVATE_logDebug(Yt, "Ignoring unexpected query state notification.");
  const s = i.iu.get(t);
  ...
  if (r.hu) {
    for (const e2 of t) {
      if (r.iu.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
        __PRIVATE_logDebug(Yt, "Adding an already active target " + e2);
        continue;
      }
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      return __PRIVATE_logWarn(Yt, `Loading bundle failed with ${e3}`), n2._failWith(e3), Promise.resolve(/* @__PURE__ */ new Set());
    }
  })(r, t, n).then((e2) => {
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  ...
  Au(e) {
    ...
    if (!__PRIVATE_WebStorageSharedClientState.C(t)) throw new FirestoreError(F.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0) throw this.lastTransactionError = new FirestoreError(F.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes."), this.lastTransactionError;
...
var FirestoreClient = class {
  constructor(e, t, n, r, i) {
    this.authCredentials = e, this.appCheckCredentials = t, this.asyncQueue = n, this.databaseInfo = r, this.user = User.UNAUTHENTICATED, this.clientId = __PRIVATE_AutoId.newId(), this.authCredentialListener = () => Promise.resolve(), this.appCheckCredentialListener = () => Promise.resolve(), this._uninitializedComponentsProvider = i, this.authCredentials.start(n, async (e2) => {
      __PRIVATE_logDebug(Zt, "Received user=", e2.uid), await this.authCredentialListener(e2), this.user = e2;
    }), this.appCheckCredentials.start(n, (e2) => (__PRIVATE_logDebug(Zt, "Received new app check token=", e2), this.appCheckCredentialListener(e2, this.user)));
  }
  get configuration() {
    return {
...
async function __PRIVATE_setOfflineComponentProvider(e, t) {
  e.asyncQueue.verifyOperationInProgress(), __PRIVATE_logDebug(Zt, "Initializing OfflineComponentProvider");
...
async function __PRIVATE_setOnlineComponentProvider(e, t) {
  ...
  __PRIVATE_logDebug(Zt, "Initializing OnlineComponentProvider"), await t.initialize(n, e.configuration), // The CredentialChangeListener of the online component provider takes
...
async function __PRIVATE_ensureOfflineComponents(e) {
  if (!e._offlineComponents) if (e._uninitializedComponentsProvider) {
    __PRIVATE_logDebug(Zt, "Using user provided OfflineComponentProvider");
    try {
      await __PRIVATE_setOfflineComponentProvider(e, e._uninitializedComponentsProvider._offline);
    } catch (t) {
      const n = t;
      if (!function __PRIVATE_canFallbackFromIndexedDbError(e2) {
        return "FirebaseError" === e2.name ? e2.code === F.FAILED_PRECONDITION || e2.code === F.UNIMPLEMENTED : !("undefined" != typeof DOMException && e2 instanceof DOMException) || // When the browser is out of quota we could get either quota exceeded
  ...
  } else __PRIVATE_logDebug(Zt, "Using default OfflineComponentProvider"), await __PRIVATE_setOfflineComponentProvider(e, new __PRIVATE_LruGcMemoryOfflineComponentProvider(void 0));
  return e._offlineComponents;
}
async function __PRIVATE_ensureOnlineComponents(e) {
  return e._onlineComponents || (e._uninitializedComponentsProvider ? (__PRIVATE_logDebug(Zt, "Using user provided OnlineComponentProvider"), await __PRIVATE_setOnlineComponentProvider(e, e._uninitializedComponentsProvider._online)) : (__PRIVATE_logDebug(Zt, "Using default OnlineComponentProvider"), await __PRIVATE_setOnlineComponentProvider(e, new OnlineComponentProvider()))), e._onlineComponents;
}
...
function __PRIVATE_firestoreClientGetDocumentFromLocalCache(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_readDocumentFromCache(e2, t2, n2) {
    try {
      ...
      r.isFoundDocument() ? n2.resolve(r) : r.isNoDocument() ? n2.resolve(null) : n2.reject(new FirestoreError(F.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
    } catch (e3) {
    ...
    const s = new __PRIVATE_AsyncObserver({
      next: (_) => {
        ...
        !a && _.fromCache ? (
          ...
          i.reject(new FirestoreError(F.UNAVAILABLE, "Failed to get document because the client is offline."))
        ) : a && _.fromCache && r2 && "server" === r2.source ? i.reject(new FirestoreError(F.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i.resolve(_);
      },
...
function collectionGroup(e, t) {
  if (e = __PRIVATE_cast(e, Firestore$1), __PRIVATE_validateNonEmptyArgument("collectionGroup", "collection id", t), t.indexOf("/") >= 0) throw new FirestoreError(F.INVALID_ARGUMENT, `Invalid collection ID '${t}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
  return new Query(
    e,
    /* converter= */
    null,
...
function initializeFirestore(e, t, n) {
  ...
  if (void 0 !== t.cacheSizeBytes && -1 !== t.cacheSizeBytes && t.cacheSizeBytes < vt) throw new FirestoreError(F.INVALID_ARGUMENT, "cacheSizeBytes must be at least 1048576");
  return r.initialize({
    options: t,
...
var Bytes = class _Bytes {
  ...
  static fromBase64String(e) {
    try {
      ...
      throw new FirestoreError(F.INVALID_ARGUMENT, "Failed to construct data from Base64 string: " + e2);
    }
  }
  /**
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  lc(e) {
    if (0 === e.length) throw this.Tc("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.oc) && sn.test(e)) throw this.Tc('Document fields cannot begin and end with "__"');
  }
};
...
function __PRIVATE_parseSetData(e, t, n, r, i, s = {}) {
  ...
  if (s.merge) a = new FieldMask(o.fieldMask), u = o.fieldTransforms;
    ...
    for (const r2 of s.mergeFields) {
      ...
      if (!o.contains(i2)) throw new FirestoreError(F.INVALID_ARGUMENT, `Field '${i2}' is specified in your field mask but missing from your input data.`);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.oc) throw 1 === e.oc ? e.Tc(`${this._methodName}() can only appear at the top level of your update data`) : e.Tc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.oc)) throw t2.Tc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path) throw t2.Tc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.cc && 4 !== t.oc) throw t.Tc("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n)) throw t2.Tc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
            ...
            [ut]: {
              arrayValue: {
                values: e3.toArray().map((e4) => {
                  if ("number" != typeof e4) throw t3.Tc("VectorValues must only contain numeric values.");
...
function __PRIVATE_fieldPathFromDotSeparatedString(e, t, n) {
  if (t.search(on) >= 0) throw __PRIVATE_createError(
...
function __PRIVATE_createError(e, t, n, r, i) {
  ...
  let a = "";
  return (s || o) && (a += " (found", s && (a += ` in field ${r}`), o && (a += ` in document ${i}`), a += ")"), new FirestoreError(F.INVALID_ARGUMENT, _ + e + a);
}
...
function __PRIVATE_validateHasExplicitOrderByForLimitToLast(e) {
  if ("L" === e.limitType && 0 === e.explicitOrderBy.length) throw new FirestoreError(F.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
function query(e, t, ...n) {
  ...
  t instanceof AppliableConstraint && r.push(t), r = r.concat(n), function __PRIVATE_validateQueryConstraintArray(e2) {
    ...
    if (t2 > 1 || t2 > 0 && n2 > 0) throw new FirestoreError(F.INVALID_ARGUMENT, "InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.");
  }(r);
...
var QueryFieldFilterConstraint = class _QueryFieldFilterConstraint extends QueryConstraint {
  ...
  _parse(e) {
    const t = __PRIVATE_newUserDataReader(e.firestore), n = function __PRIVATE_newQueryFilter(e2, t2, n2, r, i, s, o) {
      let _;
      if (i.isKeyField()) {
        if ("array-contains" === s || "array-contains-any" === s) throw new FirestoreError(F.INVALID_ARGUMENT, `Invalid Query. You can't perform '${s}' queries on documentId().`);
        if ("in" === s || "not-in" === s) {
...
var QueryOrderByConstraint = class _QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(e) {
    const t = function __PRIVATE_newQueryOrderBy(e2, t2, n) {
      if (null !== e2.startAt) throw new FirestoreError(F.INVALID_ARGUMENT, "Invalid query. You must not call startAt() or startAfter() before calling orderBy().");
      if (null !== e2.endAt) throw new FirestoreError(F.INVALID_ARGUMENT, "Invalid query. You must not call endAt() or endBefore() before calling orderBy().");
...
function __PRIVATE_newQueryBoundFromDocOrFields(e, t, n, r) {
  if (n[0] = getModularInstance(n[0]), n[0] instanceof DocumentSnapshot$1) return function __PRIVATE_newQueryBoundFromDocument(e2, t2, n2, r2, i) {
    if (!r2) throw new FirestoreError(F.NOT_FOUND, `Can't use a DocumentSnapshot that doesn't exist for ${n2}().`);
    const s = [];
    for (const n3 of __PRIVATE_queryNormalizedOrderBy(e2)) if (n3.field.isKeyField()) s.push(__PRIVATE_refValue(t2, r2.key));
      ...
      if (__PRIVATE_isServerTimestamp(e3)) throw new FirestoreError(F.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + n3.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
      if (null === e3) {
        const e4 = n3.field.canonicalString();
        throw new FirestoreError(F.INVALID_ARGUMENT, `Invalid query. You are trying to start or end a query using a document for which the field '${e4}' (used as the orderBy) does not exist.`);
      }
      s.push(e3);
    }
  ...
  }(e._query, e.firestore._databaseId, t, n[0]._document, r);
  {
    ...
    return function __PRIVATE_newQueryBoundFromFields(e2, t2, n2, r2, i2, s) {
      ...
      if (i2.length > o.length) throw new FirestoreError(F.INVALID_ARGUMENT, `Too many arguments provided to ${r2}(). The number of arguments must be less than or equal to the number of orderBy() clauses`);
      const _ = [];
      for (let s2 = 0; s2 < i2.length; s2++) {
        const a = i2[s2];
        if (o[s2].field.isKeyField()) {
          if ("string" != typeof a) throw new FirestoreError(F.INVALID_ARGUMENT, `Invalid query. Expected a string for document ID in ${r2}(), but got a ${typeof a}`);
          if (!__PRIVATE_isCollectionGroupQuery(e2) && -1 !== a.indexOf("/")) throw new FirestoreError(F.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by documentId(), the value passed to ${r2}() must be a plain document ID, but '${a}' contains a slash.`);
          const n3 = e2.path.child(ResourcePath.fromString(a));
          if (!DocumentKey.isDocumentKey(n3)) throw new FirestoreError(F.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by documentId(), the value passed to ${r2}() must result in a valid document path, but '${n3}' is not because it contains an odd number of segments.`);
...
var AbstractUserDataWriter = class {
  ...
  convertVectorValue(e) {
    var t, n, r;
    const i = null === (r = null === (n = null === (t = e.fields) || void 0 === t ? void 0 : t[ut].arrayValue) || void 0 === n ? void 0 : n.values) || void 0 === r ? void 0 : r.map((e2) => __PRIVATE_normalizeNumber(e2.doubleValue));
...
function runTransaction(e, t, n) {
  ...
  const r = Object.assign(Object.assign({}, _n), n);
  !function __PRIVATE_validateTransactionOptions(e2) {
    if (e2.maxAttempts < 1) throw new FirestoreError(F.INVALID_ARGUMENT, "Max attempts must be at least 1");
  }(r);
  ...
  const r = function __PRIVATE_parseIndexes(e2) {
    const t2 = "string" == typeof e2 ? function __PRIVATE_tryParseJson(e3) {
      try {
        ...
        throw new FirestoreError(F.INVALID_ARGUMENT, "Failed to parse JSON: " + (null == e4 ? void 0 : e4.message));
      }
    }(e2) : e2, n2 = [];
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  static get instance() {
    return un || (un = new ___PRIVATE_TestingHooksSpiImpl(), function __PRIVATE_setTestingHooksSpi(e) {
      if (Rt) throw new Error("a TestingHooksSpi instance is already set");
      Rt = e;
    }(un)), un;
  }
  ht(e) {
